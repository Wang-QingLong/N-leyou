...
public class GoodsSearchService {
    ...
    public Map<String, List<?>> filterQuery(SearchRequest searchRequest) {
        ...
        result.put("分类", this.itemFeignClient.queryCategoriesByIds(categoryIds));
        result.put("品牌", this.itemFeignClient.queryBrandByIds(brandIds));
    ...
    private void getSpecs(Long cid, QueryBuilder query, Map<String, List<?>> result) {
        ...
        //先根据分类id，查询可搜索规格参数
        List<SpecParamDTO> specParamDTOS = this.itemFeignClient.findParams(null, cid, true);
